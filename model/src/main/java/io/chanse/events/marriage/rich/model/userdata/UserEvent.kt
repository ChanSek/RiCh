...
package io.chanse.events.marriage.rich.model.userdata

import io.chanse.events.marriage.rich.model.SessionId
import io.chanse.events.marriage.rich.model.reservations.ReservationRequest
import io.chanse.events.marriage.rich.model.reservations.ReservationRequest.ReservationRequestEntityAction.CANCEL_REQUESTED
import io.chanse.events.marriage.rich.model.reservations.ReservationRequest.ReservationRequestEntityAction.RESERVE_REQUESTED
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_CUTOFF
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_UNKNOWN
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_SUCCEEDED
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CLASH
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CUTOFF
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_UNKNOWN
...
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_WAITLISTED
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CLASH
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CUTOFF
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_UNKNOWN
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_SUCCEEDED
import io.chanse.events.marriage.rich.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_WAITLISTED
