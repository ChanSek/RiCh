...
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.CANCELLATION_DENIED_CUTOFF
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.CANCELLATION_DENIED_UNKNOWN
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.CHANGES_IN_RESERVATIONS
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.CHANGES_IN_WAITLIST
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.RESERVATIONS_REPLACED
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.RESERVATION_CANCELED
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.RESERVATION_DENIED_CLASH
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.RESERVATION_DENIED_CUTOFF
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.RESERVATION_DENIED_UNKNOWN
import io.chanse.events.marriage.rich.shared.data.userevent.UserEventMessageChangeType.WAITLIST_CANCELED
